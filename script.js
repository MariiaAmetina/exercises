...
// let firstClass = document.querySelector('.block p');
...
// let countTime = 100;
// setInterval( () => console.log(--countTime), 1000);
...
let ul166 = document.querySelector('#ul166');

for (let i = 1; i <= 10; i++) {
	let li166 = document.createElement('li');
	li166.innerHTML = i;
...
let tds179 = document.querySelectorAll('#table179 td');
let i179 = tds179.length;
...
let tds181 = document.querySelectorAll('#table181 td');
for (let i = 0; i < tds181.length; i++) {
	tds181[i].addEventListener('click', () => {
...
//1 Напишите скрипт, который добавит в каждую ячейку таблицы атрибут data-col с номером колонки таблицы, в которой находится эта ячейка.
let trs229 = document.querySelectorAll('#table229 tr');
let k229 = 1;
for (let tr of trs229) {
	tds = tr.querySelectorAll('td');
	let i = 1;
	for (let td of tds) {
		td.setAttribute('data-col', i);
		i++;
		td.setAttribute('data-row', k229);
...
//1 Найдите все ячейки третьего столбца и покрасьте их в красный фон.
let tds230 = document.querySelectorAll('#table230 td:nth-child(3)');
for (let td of tds230) {
	td.classList.add('active');
}
//2 Найдите третью ячейку первого ряда и покрасьте ее в красный фон.
let td231 = document.querySelectorAll('#table230 tr:nth-child(1) td:nth-child(3)');
for (let td of td231) {
	td.classList.add('color1');
}
//3 Найдите все четные ряды и покрасьте в них все нечетные ячейки.
let tds232 = document.querySelectorAll('#table230 tr:nth-child(even) td:nth-child(odd)');
